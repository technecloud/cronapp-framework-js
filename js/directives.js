      ...
      return {
        ...
        link: function (scope, element, attrs, ngModel) {
          ...
          ngModel.$validators[attrs.valid] = function (modelValue, viewValue) {
            ...
            if (!fieldValid) {
              element.scope().$applyAsync(function () {
      ...
      return {
        ...
        generateKendoGridInit: function (options, scope, ngModelCtrl, attrs, tooltips) {
          ...
          if (attrs && attrs.ngBeforeEdit) {
            kendoGridInit.beforeEdit = function (e) {
              scope.$eval(attrs.ngBeforeEdit);
            };
          }
          if (attrs && attrs.ngDataBinding) {
            kendoGridInit.dataBinding = function (e) {
              scope.$eval(attrs.ngDataBinding);
            };
          }
          if (attrs && attrs.ngSave) {
            kendoGridInit.save = function (e) {
              scope.$eval(attrs.ngSave);
            };
          }
          if (attrs && attrs.ngSaveChanges) {
            kendoGridInit.saveChanges = function (e) {
              scope.$eval(attrs.ngSaveChanges);
            };
          }
          if (attrs && attrs.ngRemove) {
            kendoGridInit.remove = function (e) {
    ...
    .directive('cronSelect', function ($compile) {
      return {
        ...
        link: function (scope, element, attrs, ngModelCtrl) {
          ...
          options.dataBound = attrs.ngDataBound ? function () {
            scope.$eval(attrs.ngDataBound)
          } : undefined;
          options.filtering = attrs.ngFiltering ? function () {
            scope.$eval(attrs.ngFiltering)
          } : undefined;
          options.open = attrs.ngOpen ? function () {
            scope.$eval(attrs.ngOpen)
          } : undefined;
          options.select = attrs.ngSelect ? function () {
    ...
    .directive('cronDynamicSelect', function ($compile, $timeout, $parse) {
      return {
        ...
        link: function (scope, element, attrs, ngModelCtrl) {
          ...
          options.change = attrs.ngChange ? function () {
            scope.$eval(attrs.ngChange)
          } : undefined;
          options.close = attrs.ngClose ? function () {
            scope.$eval(attrs.ngClose)
    ...
    .directive('cronMultiSelect', function ($compile, $parse) {
      return {
        ...
        link: function (scope, element, attrs, ngModelCtrl) {
          ...
          options['change'] = attrs.onChange ? function () {
            eval(attrs.onChange)
          } : undefined;
          options['close'] = attrs.onClose ? function () {
            eval(attrs.onClose)
          } : undefined;
          options['dataBound'] = attrs.onDatabound ? function () {
            eval(attrs.onDatabound)
          } : undefined;
          options['filtering'] = attrs.onFiltering ? function () {
            eval(attrs.onFiltering)
          } : undefined;
          options['open'] = attrs.onOpen ? function () {
            eval(attrs.onOpen)
          } : undefined;
          options['cascade'] = attrs.onCascade ? function () {
            eval(attrs.onCascade)
          } : undefined;
          evtSelect = attrs.onSelect ? function () {
            eval(attrs.onSelect)
          } : undefined;
          deselect = attrs.onDeselect ? function () {
            eval(attrs.onDeselect)
          } : undefined;
    ...
    .directive('cronSlider', function ($compile) {
      return {
        ...
        link: function (scope, element, attrs, ngModelCtrl) {
          ...
          config.slide = attrs.ngSlide ? function () {
...
app.kendoHelper = {
  getSchema: function (dataSource) {
    var parseAttribute = [
      ...
      {
        kendoType: "number",
        entityType: ["integer", "long", "double", "int", "float", "bigdecimal", "single", "int32", "int64", "decimal", "byte"]
      },
